...
public interface SalesSystemDAO {
    ...
    List<Purchase> getLastTenTransactions();

    List<Purchase> getBetweenDates(LocalDate startDate, LocalDate endDate);
    ...
    void savePurchaseforhistory(Purchase purchase);
    Purchase getTransactionbyID(long id);
    }
